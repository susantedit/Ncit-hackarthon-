...
import MandiSathi from './pages/MandiSathi'
import GovServices from './pages/GovServices'
import FairScan from './pages/FairScan'
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/mandi"      element={<MandiSathi />} />
        <Route path="/government" element={<GovServices />} />
        <Route path="/fairscan"   element={<FairScan />} />
      </Routes>
      <PWAInstallPrompt />
      <OnboardingTour />
      <BackToTop />
