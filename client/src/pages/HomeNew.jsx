...
import {
  ...
  Globe, Lock, ShieldCheck, TrendingUp, Building2, ScanLine,
} from 'lucide-react'
...
import SathiFooter from '../components/SathiFooter'

// ── Data ─────────────────────────────────────────────────────────────────────

const pillars = [
  { Icon: Brain,       label: 'AI Chat',      subtitle: 'Multilingual Assistant',      accent: '#3b82f6', path: '/chat',         badge: null,    gradient: 'linear-gradient(135deg,rgba(59,130,246,0.18),rgba(16,185,129,0.08))', border: 'rgba(59,130,246,0.35)' },
  { Icon: ShieldCheck, label: 'Fact Checker',  subtitle: 'Evidence-Based Verification', accent: '#10b981', path: '/verification',  badge: 'New',   gradient: 'linear-gradient(135deg,rgba(16,185,129,0.16),rgba(79,140,255,0.10))', border: 'rgba(16,185,129,0.35)' },
  { Icon: TrendingUp,  label: 'Mandi Sathi',   subtitle: 'Live Market Prices',          accent: '#f59e0b', path: '/mandi',        badge: null,    gradient: 'linear-gradient(135deg,rgba(245,158,11,0.18),rgba(239,68,68,0.08))',  border: 'rgba(245,158,11,0.35)' },
  { Icon: ScanLine,    label: 'FairScan',       subtitle: 'AI Price Fairness',           accent: '#a855f7', path: '/fairscan',     badge: null,    gradient: 'linear-gradient(135deg,rgba(168,85,247,0.18),rgba(236,72,153,0.08))', border: 'rgba(168,85,247,0.35)' },
  { Icon: Building2,   label: 'Gov Services',   subtitle: 'Document Navigator',          accent: '#ef4444', path: '/government',   badge: null,    gradient: 'linear-gradient(135deg,rgba(239,68,68,0.18),rgba(245,158,11,0.10))',  border: 'rgba(239,68,68,0.35)' },
]
...
const stats = [
  { value: '5',    label: 'AI Modules',    gradient: 'linear-gradient(135deg,#3b82f6,#10b981)' },
  { value: '5+',   label: 'Languages',     gradient: 'linear-gradient(135deg,#10b981,#3b82f6)' },
  { value: 'Live', label: 'Evidence Check',gradient: 'linear-gradient(135deg,#f59e0b,#ef4444)' },
  { value: 'Free', label: 'Always',        gradient: 'linear-gradient(135deg,#a855f7,#3b82f6)' },
]

const whatsNew = [
  { Icon: ShieldCheck, label: 'Fact Checker', badge: 'Improved', desc: 'Retrieval-first fact verification with live evidence and confidence scoring.', color: '#10b981', path: '/verification' },
  { Icon: Brain,       label: 'AI Chat',      badge: 'Updated',  desc: 'Multilingual AI assistant for Nepal in Nepali, English, Hindi and more.',    color: '#3b82f6', path: '/chat' },
  { Icon: TrendingUp,  label: 'Mandi Sathi',  badge: 'New',      desc: 'Live vegetable and commodity market prices across Nepal districts.',         color: '#f59e0b', path: '/mandi' },
]

// ── How It Works steps ───────────────────────────────────────────────────────
const howItWorks = [
  { Icon: Mic,      label: 'Ask',      desc: 'Type or speak in Nepali, Hindi, or English.',            color: '#3b82f6' },
  { Icon: Globe,    label: 'Retrieve', desc: 'Sathi AI fetches relevant context and live evidence.',    color: '#10b981' },
  { Icon: Brain,    label: 'Reason',   desc: 'The AI synthesizes grounded, accurate answers.',          color: '#a855f7' },
  { Icon: Zap,      label: 'Respond',  desc: 'Get a clear answer with sources and confidence scores.',  color: '#f59e0b' },
]
      ...
      >
        ...
        <div style={{
          ...
          >
            ...
            >
              <Sparkles size={12} />
              NCIT Hackathon &middot; Team Bug Bahadur
            </motion.div>
            ...
            >
              <span className="grad-text-2">Sathi AI</span>
              <br />
              <span style={{ color: '#f0f4ff' }}>Intelligent Multilingual Platform for Nepal</span>
            </motion.h1>
            ...
            >
              Your AI companion for trustworthy information, multilingual assistance, market prices, fact checking, and government services — all in one platform.
            </motion.p>
            ...
            >
              <motion.button
                className="btn"
                style={{ width: 'auto', paddingInline: 28, fontSize: 15, background: 'linear-gradient(135deg,#3b82f6,#10b981)' }}
                whileHover={{ scale: 1.04, boxShadow: '0 12px 40px rgba(59,130,246,0.45)' }}
                whileTap={{ scale: 0.97 }}
                onClick={() => { playClickSound(); navigate('/assistant') }}
                onHoverStart={playHoverSound}
              >
                <Brain size={16} /> Try AI Chat
              </motion.button>
              <motion.button
                className="btn"
                style={{ width: 'auto', paddingInline: 28, fontSize: 15, background: 'linear-gradient(135deg,#10b981,#3b82f6)' }}
                whileHover={{ scale: 1.04, boxShadow: '0 12px 40px rgba(16,185,129,0.50)' }}
                whileTap={{ scale: 0.97 }}
                onClick={() => { playClickSound(); navigate('/verification') }}
                onHoverStart={playHoverSound}
              >
                <ShieldCheck size={16} /> Fact Checker
              </motion.button>
            </motion.div>
        ...
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <p style={{ fontSize: 14, color: '#94a3b8', maxWidth: 520, margin: '0 auto', lineHeight: 1.7 }}>
              Every module is purpose-built for Nepal — multilingual, evidence-based, and locally relevant.
            </p>
          </div>
