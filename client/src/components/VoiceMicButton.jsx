          ...
          <div style={{ position: 'relative' }}>
            <div style={{ position: 'absolute', right: 0, top: 8, zIndex: 60, width: 360 }}>
              <StegRecorder onRecordingComplete={async (blob) => {
                ...
                setRecOpen(false)
                alert('Recording saved locally as recording.wav. Server STT unavailable; paste transcription here or configure STT_PROVIDER=GROQ on the server.')
